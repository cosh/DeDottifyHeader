...
namespace DeDottifyHeader.Tests
{
    ...
    {
        private readonly CsvHeaderProcessor _processor;
        ...
        [Fact]
        public void CleanHeader_WithComplexReplacementScenario_HandlesRealWorldExample()
        {
            // Arrange - Real-world CSV header scenario
            string originalHeader = "Customer.ID|First Name|Last-Name|Email@Address|Phone.Number";
            var settings = new ProcessingSettings
            {
                ColumnSeparator = "|",
                Replacements = new List<StringReplacement>
                {
                    ...
                    new StringReplacement { Find = " ", Replace = "_" },
                    new StringReplacement { Find = "-", Replace = "_" },
                    new StringReplacement { Find = "@", Replace = "_At_" }
                }
            };
            ...
            // Assert
            Assert.Equal("Customer_ID|First_Name|Last_Name|Email_At_Address|Phone_Number", result);
        }
    }
}